...
(lib.Pieces10 = function(mode,startPosition,loop) {
	...
	this.lima.name = "lima";
	this.lima.setTransform(299.8,470.8,0.4488,0.4488,0,0,0,132.8,50.1);
	new cjs.ButtonHelper(this.lima, 0, 1, 1);

	this.empat = new lib.drop14G4();
	this.empat.name = "empat";
	this.empat.setTransform(299.85,416.65,0.4488,0.4488,0,0,0,140,40.6);
	new cjs.ButtonHelper(this.empat, 0, 1, 1);

	this.tiga = new lib.drop14G3();
	this.tiga.name = "tiga";
	this.tiga.setTransform(299.8,371.5,0.4488,0.4488,0,0,0,137.8,46.1);
	new cjs.ButtonHelper(this.tiga, 0, 1, 1);

	this.dua = new lib.drop14G2();
	this.dua.name = "dua";
	this.dua.setTransform(299.8,315.8,0.4488,0.4488,0,0,0,135.7,57.4);
	new cjs.ButtonHelper(this.dua, 0, 1, 1);

	this.satu = new lib.drop14G1();
	this.satu.name = "satu";
	this.satu.setTransform(299.75,251.35,0.4488,0.4488,0,0,0,124.5,63.3);
...
}).prototype = getMCSymbolPrototype(lib.Pieces10, new cjs.Rectangle(229.4,202.2,140.6,299), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bitmap143.png?1593770993168", id:"Bitmap143"},
		{src:"images/Bitmap144.png?1593770993168", id:"Bitmap144"},
		{src:"images/Bitmap147.png?1593770993168", id:"Bitmap147"},
		{src:"images/Bitmap153.png?1593770993168", id:"Bitmap153"},
		{src:"images/Bitmap152.png?1593770993168", id:"Bitmap152"},
		{src:"images/Bitmap145.png?1593770993168", id:"Bitmap145"},
		{src:"images/Bitmap2.png?1593770993168", id:"Bitmap2"},
		{src:"images/Bitmap3.png?1593770993168", id:"Bitmap3"},
		{src:"images/bookpngcopy.png?1593770993168", id:"bookpngcopy"},
		{src:"images/Bitmap148.png?1593770993168", id:"Bitmap148"},
		{src:"images/Bitmap146.png?1593770993168", id:"Bitmap146"}
	],
	preloads: []
};
